      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        @media print {
          ...
          * {
          ...
          /* 1. Sembunyikan SEMUA elemen website yang tidak terkait dengan invoice */
          body *:not(#print-area):not(#print-area *):not(:has(#print-area)) { 
             display: none !important;
          }
          
          /* 2. Bersihkan styling (background gelap, border, margin) dari semua container parents (seperti div#__next, main, dll) */
          body, body *:has(#print-area) {
             margin: 0 !important;
             padding: 0 !important;
          ...
          /* 3. Render khusus kanvas Kertas Invoice-nya saja */
          #print-area { 
