...
// =========================================================================
// 1. TRUE 3D CUBE STUDIO (FIX: 6 SISI DAN RESET)
// =========================================================================
...
// =========================================================================
// 2. VECTOR SHAPES (FIX: LAYER SYSTEM, CENTERED, SQUARE ROUNDED)
// =========================================================================
        ...
        >
          {mergedPixels.map((bg, i) => (
            <div 
              ...
              className={`w-full h-full border-[0.5px] pointer-events-none ${isTransparent ? 'border-white/10' : (canvasBgColor==='#ffffff'?'border-black/10':'border-white/20')}`}
