...
<th style="padding: 10px; text-align: left; border: 1px solid #ddd;">Fase & Nama File</th>
<th style="padding: 10px; text-align: left; border: 1px solid #ddd;">Keterangan / Target</th>
</tr>
<!-- FASE 1 -->
<tr style="background-color: #f0fdf4;">
<td style="padding: 10px; text-align: center; border: 1px solid #ddd;">✅</td>
<td style="padding: 10px; border: 1px solid #ddd;"><b>Fase 1: Server & Domain</b>
<code>Vercel & Niagahoster</code></td>
<td style="padding: 10px; border: 1px solid #ddd;">Menyambungkan domain mrr.my.id ke server Vercel (Berhasil online 100%).</td>
</tr>
<!-- FASE 2 -->
<tr style="background-color: #f8fafc;">
<td style="padding: 10px; text-align: center; border: 1px solid #ddd;">✅</td>
<td style="padding: 10px; border: 1px solid #ddd;"><b>Fase 2: Konfigurasi Awal</b>
<code>layout.jsx</code> & <code>globals.css</code></td>
<td style="padding: 10px; border: 1px solid #ddd;">Setup font, warna dasar (Tailwind), dan layout induk website.</td>
</tr>
<!-- FASE 3 -->
<tr style="background-color: #fffbeb;">
<td style="padding: 10px; text-align: center; border: 1px solid #ddd;">⏳</td>
<td style="padding: 10px; border: 1px solid #ddd;"><b>Fase 3: Pecah Halaman (Multipage)</b>
<code>app/page.jsx</code> (Home)
<code>app/projects/page.jsx</code> (Galeri)</td>
<td style="padding: 10px; border: 1px solid #ddd;">(Sedang Dikerjakan) Memisahkan halaman utama dan halaman galeri agar lebih rapi.</td>
</tr>
<!-- FASE 4 -->
<tr style="background-color: #fffbeb;">
<td style="padding: 10px; text-align: center; border: 1px solid #ddd;">⏳</td>
<td style="padding: 10px; border: 1px solid #ddd;"><b>Fase 4: Database CMS</b>
<code>src/data/store.js</code></td>
<td style="padding: 10px; border: 1px solid #ddd;">(Sedang Dikerjakan) Merapikan file pusat data supaya gampang update web dari HP.</td>
</tr>
<!-- FASE 5 -->
<tr style="background-color: #ffffff;">
<td style="padding: 10px; text-align: center; border: 1px solid #ddd;">⬜</td>
<td style="padding: 10px; border: 1px solid #ddd;"><b>Fase 5: Eksekusi Detail Karya</b>
<code>app/projects/[slug]/page.jsx</code></td>
<td style="padding: 10px; border: 1px solid #ddd;">(Belum Mulai) Bikin halaman khusus yang memanjang ke bawah saat foto diklik.</td>
</tr>
<!-- FASE 6 -->
<tr style="background-color: #ffffff;">
<td style="padding: 10px; text-align: center; border: 1px solid #ddd;">⬜</td>
<td style="padding: 10px; border: 1px solid #ddd;"><b>Fase 6: Upload Aset Final</b>
<code>public/projects/</code></td>
<td style="padding: 10px; border: 1px solid #ddd;">(Belum Mulai) Mengunggah foto desain resolusi tinggi dan logo klien.</td>
</tr>
</table>
...
​<h2 style="color: #0284c7;">🛠️ 3. Tutorial Ekstra: Tips Anti-Error (Sangat Penting!)</h2>
...
​<ul style="line-height: 1.8; background-color: #fff1f2; border-left: 5px solid #e11d48; padding: 15px 15px 15px 35px; border-radius: 5px;">
...
​<h2 style="color: #0284c7;">🚀 4. Eksekusi End-to-End (Cara Saya Update Web dari HP)</h2>
...
​<h2 style="color: #0284c7;">🖼️ 5. Tampilan Detail Karya (Anti Slider)</h2>
...
​<h2 style="color: #0284c7;">🌐 6. Daftar Halaman & Transisi (Multipage SPA)</h2>
